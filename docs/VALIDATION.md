...
- 16 Swift tests covering legacy library preservation, image import, transparency,
  ...
  shared-image retention, empty slots, and removal of missing images.
...
- `./scripts/build-app.sh --release` correctly refused to run without a Developer
  ID Application signing identity (exit 2). Only Apple Development certificates
  were available on this machine; notarization has not been performed.
